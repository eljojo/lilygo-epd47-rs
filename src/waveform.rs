...
/// epdiy ED047TC2 mode-5 (GC16 16-gray) waveform for a temperature bucket: `range_idx` 0 = coldest
/// (`5_5`, ~15 °C) .. 6 = hottest (`5_11`, ~33–38 °C). Each entry is `[phase][16 target-gray][4 bytes]`
/// where the 4 bytes pack 16 source-grays × 2-bit ops (0 = no-op, 1 = darken, 2 = lighten), MSB-first.
/// The driver replays each phase from a WHITE source. Mode 5 (not 2) because its white→white is a true
/// no-op, which suits the fork's clear-then-draw model.
pub fn mode5_bucket(range_idx: usize) -> &'static [[[u8; 4]; 16]] {
    match range_idx {
        0 => &EPD_WP_ED047TC2_5_5_DATA,
        1 => &EPD_WP_ED047TC2_5_6_DATA,
        2 => &EPD_WP_ED047TC2_5_7_DATA,
        3 => &EPD_WP_ED047TC2_5_8_DATA,
        4 => &EPD_WP_ED047TC2_5_9_DATA,
        5 => &EPD_WP_ED047TC2_5_10_DATA,
        _ => &EPD_WP_ED047TC2_5_11_DATA,
    }
}
